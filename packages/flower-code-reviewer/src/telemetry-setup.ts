 ...
 * 而 sink 的开关逻辑(FLOWER_VERBOSE / FLOWER_TELEMETRY_FILE)是环境策略,单独放便于单测。
 *
 * 装配规则:
...
import { consoleSink, jsonlSink, siemSink, type TelemetrySink } from "@flower-ai/flower-telemetry";
