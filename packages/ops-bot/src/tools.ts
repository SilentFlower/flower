 ...
 * 工具装配
 *
 * 把 @flower-ai/pi-tools-arms 和 @flower-ai/pi-tools-common 提供的工具转成
...
} from "@flower-ai/pi-tools-arms";
import { jiraSearchTool, wikiSearchTool } from "@flower-ai/pi-tools-common";
...
export function buildToolList(ctx: { userId: string }): AgentTool<any>[] {
	...
	return [
		...
		toAgentTool(jiraSearchTool),
		toAgentTool(wikiSearchTool),
	];
}
